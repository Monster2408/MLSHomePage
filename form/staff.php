<?php
    ...
    if( !empty($_POST['btn_confirm']) ) {
        ...
        $genre = 'その他';
        if( !empty($_POST['age']) && $_POST['age'] === "1" ){ $genre = '運営'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "2" ){ $genre = 'Developer(Plugin)'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "3" ){ $genre = 'Developer(Skript)'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "4" ){ $genre = '動画編集者'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "5" ){ $genre = 'ウェブデベロッパー(PHP)'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "6" ){ $genre = '非公式WIKIデベロッパー(SeesaaWiki)'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "7" ){ $genre = 'テクスチャデザイナー'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "8" ){ $genre = 'ビルダー'; } 
        if( !empty($_POST['age']) && $_POST['age'] === "9" ){ $genre = 'その他'; }
                ...
                <div class="contents">
                    <div class="text_box">
                        ...
                        <form method="post" action="" name="input">
                            ...
                            <div class="element_wrap">
                                <label>希望役職</label>
                                <select name="age" onChange="selectNavi()" required="required">
                                    <option value="">選択してください</option>
                                    <option value="1" <?php if( !empty($_POST['age']) && $_POST['age'] === "1" ){ echo 'selected'; } ?>>運営</option>
                                    <option value="2" <?php if( !empty($_POST['age']) && $_POST['age'] === "2" ){ echo 'selected'; } ?>>Developer(Plugin)</option>
                                    <option value="3" <?php if( !empty($_POST['age']) && $_POST['age'] === "3" ){ echo 'selected'; } ?>>Developer(Skript)</option>
                                    <option value="4" <?php if( !empty($_POST['age']) && $_POST['age'] === "4" ){ echo 'selected'; } ?>>動画編集者</option>
                                    <option value="5" <?php if( !empty($_POST['age']) && $_POST['age'] === "5" ){ echo 'selected'; } ?>>ウェブデベロッパー(PHP)</option>
                                    <option value="6" <?php if( !empty($_POST['age']) && $_POST['age'] === "6" ){ echo 'selected'; } ?>>非公式WIKIデベロッパー(SeesaaWiki)</option>
                                    <option value="7" <?php if( !empty($_POST['age']) && $_POST['age'] === "7" ){ echo 'selected'; } ?>>テクスチャデザイナー</option>
                                    <option value="8" <?php if( !empty($_POST['age']) && $_POST['age'] === "8" ){ echo 'selected'; } ?>>ビルダー</option>
                                    <option value="9" <?php if( !empty($_POST['age']) && $_POST['age'] === "9" ){ echo 'selected'; } ?>>その他</option>
                                </select>
                            </div>
